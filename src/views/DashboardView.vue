        ...
        <v-row class="dashboard-row mt-8" no-gutters>
            <v-col cols="12">
                <div class="dashboard-section">
                    <div class="dashboard-section-header">
                        <span class="dashboard-section-title"
                            >Pago de Servicios</span
                        >
                        <a href="/dashboard/pagos" class="dashboard-link"
                            >Ver más<v-icon size="16"
                    ...
                    <div class="dashboard-services-carousel-wrapper">
                        <v-slide-group
                            class="dashboard-services-group"
                            show-arrows
                        >
                            <v-slide-group-item
                            ...
                            >
                                <div class="dashboard-service-card">
                                    <div class="dashboard-service-header">
                                        <div
                                            class="dashboard-service-header-left"
                                        >
                                            <span
                                                class="dashboard-service-title"
                                                >{{ bill.title }}</span
                                            >
                                            <span
                                                class="dashboard-service-provider"
                                                >{{ bill.provider }}</span
                                            >
                                        </div>
                                        <div
                                            class="dashboard-service-header-right"
                                        >
                                            <a
                                                href="/dashboard/pagos"
                                                class="dashboard-link-header"
                                                >Pagar</a
                                            >
                                        </div>
                                    </div>
                                    <div class="dashboard-service-body">
                                        <div class="dashboard-service-amount">
                                            ${{
                                        ...
                                        <div class="dashboard-service-date">
                                            {{ bill.due_date }}
                                        </div>
                                    </div>
                                </div>
